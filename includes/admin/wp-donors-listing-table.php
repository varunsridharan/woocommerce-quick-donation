 ...
 */
class WP_Donors_Listing_Table extends WP_List_Table {
	...
	public function prepare_items() {
        ...
        $args['offset'] = ( $paged-1 ) * $users_per_page;
        $args['role'] = 'customer';
	...
	public function get_columns() {
		$c = array(
			...
			'name'     => __( 'Name' ),
			'email'    => __( 'E-mail' ),
			'projects'    => __( 'Contribute To', WC_QD_TXT ),
            'donations'     => __( 'Total Donations',WC_QD_TXT ),
...
function donor_render_list_page($shop = ''){  
    $wc_qd_donation_orders_listing = new WP_Donors_Listing_Table($shop);
    $wc_qd_donation_orders_listing->prepare_items();
?>
<div class="wrap">
    <div id="icon-users" class="icon32"><br/></div>
    <h2>Donors</h2>
    <form id="donors_listing" method="get"> 
