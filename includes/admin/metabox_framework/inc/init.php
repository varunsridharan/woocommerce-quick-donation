<?php
add_action( 'admin_init', 'wcqd_metabox_register_meta_boxes' );
 ...
 * @return void
 */
function wcqd_metabox_register_meta_boxes()
{
...
add_action( 'edit_page_form', 'wcqd_metabox_fix_page_template' );
 ...
 * @since 4.3.10
 */
function wcqd_metabox_fix_page_template( $post )
{
